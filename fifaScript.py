...
df['scatter_plot'] = df['Value'] / df['Wage']

    #Its sort the information with the height values at the top

df_order_sp = df.sort_values(by='scatter_plot', ascending=False) 
